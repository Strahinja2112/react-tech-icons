...
export function Ansible({ height, width }: IconProps) {
	return (
		<svg
		...
		>
			...
			<path
				fill="#FFF"
				d="M64.9 32.8L78 65 58.3 49.5l6.6-16.7zm23.2 39.6l-20-48.3c-.6-1.4-1.7-2.1-3.1-2.1-1.4 0-2.6.7-3.2 2.1l-22 53h7.5L56 55.2l26 21c1 .8 1.8 1.2 2.8 1.2 2 0 3.7-1.5 3.7-3.6 0-.3-.2-.8-.4-1.4z"
			/>
		</svg>
	);
}

export function AnsiblePlain({ height, width }: IconProps) {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			height={height || "30"}
		...
		>
			...
			/>
			<path fill="#1A1918" d="M65 39.9l16.1 39.6-24.3-19.1z" />
		</svg>
	);
}
