...
export function CMakeWithWords({ height, width, color }: IconProps) {
  return (
    <svg
...
export function CMakeSolidWithWords({ height, width, color }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={height || defaultSize}
